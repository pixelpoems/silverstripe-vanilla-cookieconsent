<% with $SiteConfig.CCInsightData %>
    ...
    <div style="display: flex; flex-direction: row; margin-bottom: 4rem; gap: 2rem; flex-wrap: wrap;">
        <div>
        ...
        <div style="margin-left: 2rem">
            ...
            <span style="font-size: small; color:#9c9595">Note: Necessary cookies can not be rejected.</span>
        </div>
    </div>
<% end_with %>
